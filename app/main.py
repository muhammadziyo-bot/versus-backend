...
def run_schema_migration():
    try:
        with engine.connect() as conn:
            ...
            conn.execute(text("CREATE TABLE IF NOT EXISTS battle_turns (id SERIAL PRIMARY KEY, battle_room_id INTEGER REFERENCES battle_rooms(id) NOT NULL, round_number INTEGER NOT NULL DEFAULT 1, turn_number INTEGER NOT NULL DEFAULT 1, side VARCHAR NOT NULL, argument TEXT NOT NULL, submitted_at TIMESTAMP WITH TIME ZONE DEFAULT NOW())"))
            conn.commit()
